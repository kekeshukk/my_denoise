...
`timescale 1 ns / 1 ps
	...
	module the_controller_axi_v1_0 #
	(
	...
	(
		...
		output			cmd_vld,//命令有效位,slv_reg0[0]高有效
		output	[4 * C_S0_AXI_DATA_WIDTH - 1 : 0] cmd_out,//命令,排列方式从高到低位{slv_reg3,...,slv_reg_0}
		// User ports ends
