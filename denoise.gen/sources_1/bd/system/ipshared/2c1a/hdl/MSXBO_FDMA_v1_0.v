...
`timescale 1 ns / 1 ps
    ...
    parameter    integer      C_M00_AXI_ID             = 0             ,
    ...
    input   wire [C_M00_AXI_DATA_WIDTH-1 :0]    pkg_wr_data        ,
    output  wire                                pkg_wr_en          ,
	input   wire [C_M00_AXI_ADDR_WIDTH-1 :0]    pkg_wr_addr			, 
    input   wire [C_M00_AXI_ADDR_WIDTH-1 :0]    pkg_wr_size        , 	
    input   wire                                pkg_rd_areq        ,
    output  wire                                pkg_rd_last        ,
    output  wire [C_M00_AXI_DATA_WIDTH-1 :0]    pkg_rd_data        ,        
    output  wire                                pkg_rd_en          ,
	input   wire [C_M00_AXI_ADDR_WIDTH-1 :0]    pkg_rd_addr	        ,
    input   wire [C_M00_AXI_ADDR_WIDTH-1 :0]    pkg_rd_size        , 
...
// Instantiation of Axi Bus Interface M00_AXI
    ...
    .C_M_AXI_ID                           (C_M00_AXI_ID                     ),
    .C_M_AXI_ADDR_WIDTH                   (C_M00_AXI_ADDR_WIDTH             ),
    .C_M_AXI_DATA_WIDTH                   (C_M00_AXI_DATA_WIDTH             )
	) MSXBO_FDMA_v1_0_M00_AXI_inst 
	(   
