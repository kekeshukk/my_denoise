...
# Path of this script: C:\Users\wwwka\Desktop\my_cnn\denoise\work\my_denoise_system\_ide\scripts\systemdebugger_my_denoise_system_standalone.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source C:\Users\wwwka\Desktop\my_cnn\denoise\work\my_denoise_system\_ide\scripts\systemdebugger_my_denoise_system_standalone.tcl
# 
...
set bp_16_14_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_16_14_fsbl_bp
targets -set -nocase -filter {name =~ "*A53*#0"}
rst -processor
