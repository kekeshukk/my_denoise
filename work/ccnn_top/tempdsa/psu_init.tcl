...
set psu_pll_init_data {
    ...
    mask_write 0XFD1A002C 0x00717F00 0x00014C00
		# : BY PASS PLL
		# Register : DPLL_CTRL @ 0XFD1A002C</p>
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E0074 0x013F3F07 0x01011000
    ...
    mask_write 0XFF5E00A4 0x01003F07 0x01000900
    ...
    mask_write 0XFF5E00AC 0x01003F07 0x01001002
    ...
    mask_write 0XFF5E00B0 0x01003F07 0x01000702
    ...
    mask_write 0XFF5E0108 0x013F3F07 0x01021402
    ...
    mask_write 0XFD1A0068 0x01003F07 0x01000400
    ...
    mask_write 0XFD1A0084 0x07003F07 0x07000202
    ...
    mask_write 0XFD1A00C4 0x01003F07 0x01000802
    ...
    mask_write 0XFD1A00F8 0x00003F07 0x00000400
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070024 0xFFFFFFFF 0x0026A7BC
    ...
    mask_write 0XFD070034 0x00FFFF1F 0x00403F10
    ...
    mask_write 0XFD070064 0x0FFF83FF 0x001E8047
    ...
    mask_write 0XFD0700D0 0xC3FF0FFF 0x000201F0
    ...
    mask_write 0XFD0700D4 0x01FF7F0F 0x00330000
    ...
    mask_write 0XFD0700D8 0x0000FF0F 0x00001105
    ...
    mask_write 0XFD070100 0x7F3F7F3F 0x0D0B080B
    ...
    mask_write 0XFD070104 0x001F1F7F 0x00030410
    ...
    mask_write 0XFD070108 0x3F3F3F3F 0x0305130C
    ...
    mask_write 0XFD070180 0xF7FF03FF 0x80FE0008
    ...
    mask_write 0XFD070184 0x3FFFFFFF 0x00D3051A
    ...
    mask_write 0XFD080018 0xFFFFFFFF 0x00F039E8
    ...
    mask_write 0XFD080040 0xFFFFFFFF 0x1FC0FD90
    ...
    mask_write 0XFD080044 0xFFFFFFFF 0x62F608E8
    ...
    mask_write 0XFD080110 0xFFFFFFFF 0x06160C08
    ...
    mask_write 0XFD080118 0xFFFFFFFF 0x000F0092
    ...
    mask_write 0XFD080120 0xFFFFFFFF 0x008E2B08
    ...
    mask_write 0XFD080124 0xFFFFFFFF 0x00200E08
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0x0161E000 0x01000000
    ...
    mask_write 0XFF180208 0x0000000C 0x00000004
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF000018 0x0000FFFF 0x00000074
...
mwr -force  0xFD080018 0x00F079E8
...
poll 0xFD080030 0x00004001 0x00004001
 ...
 #//Poll PUB_PGSR0 for Trng complete  
mwr -force  0xFD080200 0x800091C7
mwr -force  0xFD080018 0x00F08957
...
poll 0xFD080030 0x00000C01 0x00000C01
 ...
 #//Poll PUB_PGSR0 for Trng complete  
mwr -force  0xFD070180 0x00FE0008
