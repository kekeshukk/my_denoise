...
HD_PWD='C:/Users/wwwka/Desktop/my_cnn/denoise/denoise.runs/result_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log result.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source result.tcl
