...
HD_PWD='C:/Users/wwwka/Desktop/my_cnn/denoise/denoise.runs/system_MSXBO_FDMA_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_MSXBO_FDMA_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_MSXBO_FDMA_0_0.tcl
