...
HD_PWD='C:/Users/wwwka/Desktop/my_cnn/denoise/denoise.runs/weight_inc_0_conv_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weight_inc_0_conv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weight_inc_0_conv.tcl
