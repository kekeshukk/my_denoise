...
HD_PWD='C:/Users/wwwka/Desktop/my_cnn/denoise/denoise.runs/impl_1_copy_1'
cd "$HD_PWD"
...
EAStep vivado -log ccnn_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ccnn_top.tcl -notrace
