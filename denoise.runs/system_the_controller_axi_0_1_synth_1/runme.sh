...
HD_PWD='C:/Users/wwwka/Desktop/my_cnn/denoise/denoise.runs/system_the_controller_axi_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_the_controller_axi_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_the_controller_axi_0_1.tcl
