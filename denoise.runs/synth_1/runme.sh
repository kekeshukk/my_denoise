...
HD_PWD='C:/Users/wwwka/Desktop/my_cnn/denoise/denoise.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ccnn_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ccnn_top.tcl
