...
HD_PWD='C:/Users/wwwka/Desktop/my_cnn/denoise/denoise.runs/fifo_dram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_dram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_dram.tcl
