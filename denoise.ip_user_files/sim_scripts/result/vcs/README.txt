...
#
# Generated by export_simulation on Thu Aug 04 23:52:53 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './result.sh' script.
...
./result.sh -noclean_files

For more information on the script, please type './result.sh -help'.
