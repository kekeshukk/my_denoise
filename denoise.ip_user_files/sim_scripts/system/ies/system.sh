...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../denoise.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../denoise.gen/sources_1/bd/system/ipshared/bb17/hdl" \
       +incdir+"../../../../denoise.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../denoise.gen/sources_1/bd/system/ipshared/bb17/hdl" \
